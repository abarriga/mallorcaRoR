...
$(document).ready(function() {
	$('form#contact_form').submit(function() {
	    ...
	    if(jQuery.trim($(this).val()) == '' || jQuery.trim($(this).val()) == labelText) {
            	
            	$(this).parent().append('<span class="error">Debe introducir un '+labelText+'.</span>');
            	...
            	if(!emailReg.test(jQuery.trim($(this).val()))) {
            		var labelText = $(this).prev('label').text();
            		$(this).parent().append('<span class="error">El '+labelText+' introducido no es correcto.</span>');
            		$(this).addClass('inputError');
            		hasError = true;
            	}
            }
...
function toggleSlide(toggleMe){
  if(document.getElementById(toggleMe).style.display == "none"){
    ...
    slidedown(toggleMe);
    document.getElementById("toogleImage").src = "/assets/close_tab.png";
    document.getElementById("toogleImage").alt = "Close";
    document.getElementById("toogleImage").title = "Close";
  }else{
    // div is not hidden, so slide up
    slideup(toggleMe);
    document.getElementById("toogleImage").src = "/assets/open_tab.png";
    document.getElementById("toogleImage").alt = "Open";
    document.getElementById("toogleImage").title = "Open";
  }
}
